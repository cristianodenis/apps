...
export default function TaskCard({done,title,when,typeIcon,description,id}){
    ...
    return(
        <View>
           <TouchableOpacity style={[styles.card, done && styles.done]} onPress={()=> navigation.navigate('Task',{done:done,title:title,data:data,hora:hora,type:typeIcon,description:description,id:id})} >
